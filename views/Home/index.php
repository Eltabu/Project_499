                ...
                <div class="features">
                    <div class="col-lg-4  col-md-4 col-sm-6">
                        <div class="feature-wrap">
                            ...
                            <h2>Complete vehicle rental system</h2>
                            <h3>All in one car rental system used by over 460 business worldwide.</h3>
                        </div>
                    </div><!--/.col-md-4-->
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
                        <div class="feature-wrap">
                            ...
                            <h2>Modules and add-ons</h2>
                            <h3>Over 15 add-on modules to choose from that can be added at any time.</h3>
                        </div>
                    </div><!--/.col-md-4-->
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
                        <div class="feature-wrap">
                            ...
                            <h2>VRS solution in the Cloud</h2>
                            <h3>Flexible pay as you go cloud pricing starting from as low as $80 per month.</h3>
                        </div>
                    </div><!--/.col-md-4-->
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
                        <div class="feature-wrap">
                            ...
                            <h2>Full featured reporting</h2>
                            <h3>Over 60 customizable car rental reports that cover all areas of the system</h3>
                        </div>
                    </div><!--/.col-md-4-->
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
                        <div class="feature-wrap">
                            ...
                            <h3>Designed by car rental counters and users worldwide, the application is easy to master, use.</h3>
                        </div>
                    </div><!--/.col-md-4-->
                </div><!--/.services-->
            </div><!--/.row-->    
