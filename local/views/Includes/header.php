...
<html lang="en">
    <head>
        ...
        <!-- Custome CSS Theme  -->
        <link href="<?php echo URL ?>app/assets/css/theme1.css" rel="stylesheet" />
        ...
        <nav class="navbar navbar-inverse" role="banner">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo URL ?>home"><img src="<?php echo URL ?>app/assets/img/logo.png" alt="logo"></a>
                </div>
